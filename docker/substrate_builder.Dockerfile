...
COPY --from=builder /substrate/target/debug/substrate /usr/local/bin
COPY --from=builder /substrate/target/debug/subkey /usr/local/bin
COPY --from=builder /substrate/target/debug/node-template /usr/local/bin
COPY --from=builder /substrate/target/debug/chain-spec-builder /usr/local/bin
